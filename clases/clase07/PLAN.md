...
**Tech Stack:** Unity 6000.3.21f1, VContainer 1.19.0, MessagePipe 1.8.2 (+ MessagePipe.VContainer 1.8.2), com.unity.ugui 2.0.0, Unity Test Framework (NUnit) EditMode/PlayMode tests run via `-runTests` batchmode.
